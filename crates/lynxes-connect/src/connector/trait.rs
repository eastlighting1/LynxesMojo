...
use lynxes_core::{
    Direction, EdgeFrame, EdgeTypeSpec, Expr, GFError, GraphFrame, NodeFrame, Result,
};
...
impl lynxes_plan::query::Connector for dyn Connector {
    fn cache_source_key(&self) -> Option<String> {
        Connector::cache_source_key(self)
    }
}
